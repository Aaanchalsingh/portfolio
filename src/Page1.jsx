    ...
    <div>
      ...
      >
        <div className="mt-[10%] ml-[15%] w-[30%] ">
          <h1 className="text-2xl text-white mb-5 font-sans ">Hello, I am</h1>
          <h1 className="text-7xl text-white font-sans font-bold ">Aanchal</h1>
          <h1 className="text-7xl text-white font-sans font-bold ">Singh</h1>
          <div>
          ...
          <div className="flex">
            <button
              className=" text-white p-3 w-[60%] h-[13%] text-xl m-5 mt-12 ml-0  rounded-[30px]"
              style={{ backgroundColor: "rgb(244, 18, 18)" }}
            >
              Hire me
            </button>
            <button className=" text-white p-3 w-[60%] h-[13%] border border-red-700 text-xl m-5 mt-12 ml-0 after:marker:mt-12 rounded-[30px] hover:bg-[#f41212]">
              Explore
            </button>
          </div>
        </div>
